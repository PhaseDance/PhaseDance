...
if __name__ == '__main__':
    ...
    # Initialize drawing
    plt.ion()
    figure1, ax1 = plt.subplots(6, 1)
    figure2, ax2 = plt.subplots(phase_channels, 5)
    ...
    for epoch in range(epochs):
        ...
        figure2.savefig("Frequencies_Amplitudes_Offsets.png")
        figure3.savefig("Amplitude Distribution.png")
        figure4.savefig("Phase Manifold.png")
